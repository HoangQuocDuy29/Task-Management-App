// ============================================
// 📁 FILE: client/src/components/forms/TicketForm.tsx
// 🎯 PURPOSE: Simple ticket form component - CODE NGẮN
...
const TicketForm: React.FC<TicketFormProps> = ({ 
  ...
  const [formData, setFormData] = useState({
    ...
    type: ticket?.type || 'bug' as const,
    status: ticket?.status || 'open' as const,
    taskId: ticket?.taskId?.toString() || '',
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const data = {
      ...
      ...(ticket && { status: formData.status }), // Only include status for updates
    };
