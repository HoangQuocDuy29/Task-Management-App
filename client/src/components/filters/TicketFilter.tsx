// ============================================
// 📁 FILE: client/src/components/filters/TicketFilter.tsx
// 🎯 PURPOSE: Simple filter component for tickets - CODE NGẮN
...
const TicketFilter: React.FC<TicketFilterProps> = ({ onSearch, onFilter, onClear, tasks = [] }) => {
  ...
  const activeFiltersCount = [statusFilter, typeFilter, taskFilter].filter(Boolean).length;
